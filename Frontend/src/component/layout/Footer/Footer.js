...
const Footer = () => {
  ...
  const Linkedin = "https://www.linkedin.com/in/amit-verma-b3450b1b4/"
  return <div className="developedwrap">
    <h3 className="developer_info">Developed By -- AMIT VERMA --</h3> 
    ...
    <footer id="footer">
      ...
      <div className="midFooter">
        ...
        <p>Copyrights 2021 &copy; Amit Verma</p>
      </div>
